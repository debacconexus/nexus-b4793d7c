...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Disaster Relief Operations Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Relief Operation Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "relief_operation_record_records";
'use strict';
